...
function VirologyTestScreen({ setCurrentScreen }) {
  ...
  // Фильтруем вопросы только по вирусологии
  const categoryQuestions = questionsData.filter(
    (q) => q.category === "virology",
  );
  ...
  useEffect(() => {
    if (!initializedRef.current) {
      ...
      //console.log(
      // "Initializing VirologyTestScreen at boundary:",
      //  progressBoundary,
      //);
    ...
    setIsPreviewMode(false);
    document.title = "Вирусология - Medical Test";
  }, [userAnswers]);
...
export default VirologyTestScreen;
