...
function ParasitologyTestScreen({ setCurrentScreen }) {
  ...
  // Фильтруем вопросы только по паразитологии
  const categoryQuestions = questionsData.filter(
    (q) => q.category === "parasitology",
  );
  ...
  useEffect(() => {
    if (!initializedRef.current) {
      ...
      //console.log(
      //  "Initializing ParasitologyTestScreen at boundary:",
      //  progressBoundary,
      //);
    ...
    setIsPreviewMode(false);
    document.title = "Паразитология - Medical Test";
  }, [userAnswers]);
      ...
      {currentQuestion < totalQuestions ? (
            ...
            <div style={{ marginTop: 12 }}>
              <img
                ...
                onError={(e) => {
                  ...
                  //console.log(
                  //  `Image not found: /images/${originalQuestionId + 1}.png`,
                  //);
                }}
              />
            </div>
        ...
        <>
          <h1 style={{ textAlign: "center", marginTop: 50 }}>
            Вы прошли тест по Паразитологии
          </h1>
...
export default ParasitologyTestScreen;
