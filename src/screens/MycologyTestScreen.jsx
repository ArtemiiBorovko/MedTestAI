...
function MycologyTestScreen({ setCurrentScreen }) {
  ...
  // Фильтруем вопросы только по микологии
  const categoryQuestions = questionsData.filter(
    (q) => q.category === "mycology",
  );
  ...
  useEffect(() => {
    if (!initializedRef.current) {
      ...
      //console.log(
      //  "Initializing MycologyTestScreen at boundary:",
      //  progressBoundary,
      //);
    ...
    setIsPreviewMode(false);
    document.title = "Микология - Medical Test";
  }, [userAnswers]);
...
export default MycologyTestScreen;
